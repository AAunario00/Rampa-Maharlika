...
<body>
	...
	<div class="welcome">
  		...
  		<h2>Rampa Maharlika</h2>
  		<p>​ Rampa Maharlika  is a local thrift shop that sells used garments, bags, and shoes for cheaper price but with quality and donates 10% income to local charities as well as the company's feeding program. Sell your secondhand garments, or buy secondhand items and feed a hungry stomach. </p>
 	</div>
 	<div class="subscribe">
